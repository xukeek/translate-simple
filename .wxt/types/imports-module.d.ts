...
declare module '#imports' {
  ...
  export { TranslationCache } from '../utils/cache';
  export { collectTextBlocks, renderTranslation, removeTranslations, injectStyles, TextBlock } from '../utils/dom';
  export { DEFAULT_CONFIG, getConfig, setConfig, updateConfig } from '../utils/storage';
}
